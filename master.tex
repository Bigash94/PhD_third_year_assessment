...
\title{Updated low-mass stellar yields including uncertainties derived from reaction rates}
...
\noindent Adsley et al. 2020 Phys. Rev. C (2020) just accepted\par
...
\include{chapter2/Yields}
\include{chapter3/Nucleosynthesis_code}
\include{chapter4/Validation_from_observable_data}
\include{chapter5/Yields_and_their_uncertainty}
